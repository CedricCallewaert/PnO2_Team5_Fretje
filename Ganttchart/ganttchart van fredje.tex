...
\begin{document}
	...
	\begin{figure}
		...
		\begin{ganttchart}[hgrid, vgrid, x unit=5mm, time slot format=isodate]{2023-02-17}{2023-05-26}
			...
			\ganttfoobar[name=2.1]{2.1 - Materialen kiezen}{2023-03-3}{2023-03-10} \\
			...
			\ganttfoobar[name=2.2.3]{2.2.3 - Omhulsel elektronica}{2023-03-17}{2023-04-07} \\
			\ganttfoobar[name=2.3]{2.3 - Assembly in SE}{2023-03-17}{2023-04-14} \\
			\ganttfoobar[name=3.0]{3.0 - Elektronica}{2023-03-17}{2023-04-21} \\
			\ganttfoobar[name=3.1]{3.1 - Elektrisch netwerk}{2023-03-17}{2023-04-21} \\
			...
			\ganttfoobar[name=4.1]{4.1 - Stuurprogramma's motoren}{2023-03-24}{2023-04-07} \\
			\ganttfoobar[name=4.2]{4.2 - Camera detectie LabVIEW}{2023-03-10}{2023-03-31} \\
			\ganttfoobar[name=4.3]{4.3 - Grafische gebruikers interface}{2023-03-24}{2023-03-31} \\
			\ganttfoobar[name=5.0]{5.0 - Berekeningen}{2023-03-03}{2023-03-24} \\
			\ganttfoobar[name=5.1]{5.1 - Waterstraalbereik}{2023-03-03}{2023-03-24} \\
			\ganttfoobar[name=5.2]{5.2 - Hoek}{2023-03-10}{2023-03-31} \\
			\ganttfoobar[name=6.0]{6.0 - Schrijven artikel}{2023-03-10}{2023-05-12} \\
